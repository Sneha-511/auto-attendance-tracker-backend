# Automatic Attendance Tracker Server

The backend is built using Node.js, Express, and Mongoose and frontend using React.
...
# URL of the Mongo DB
MONGODB_URL=mongodb://127.0.0.1:27017/auto-attendance-tracker
...
An access token is valid for 60 minutes. You can modify this expiration time by changing the `JWT_ACCESS_EXPIRATION_MINUTES` environment variable in the .env file.
